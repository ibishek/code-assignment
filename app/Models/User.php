 ...
 * @property \Illuminate\Support\Carbon|null $oauth_token_expired_at
 * @property string|null $remember_token
 * @property \Illuminate\Support\Carbon|null $created_at
 * @property \Illuminate\Support\Carbon|null $updated_at
 * @property-read \Illuminate\Database\Eloquent\Collection<int, \App\Models\ExcelData> $excels
 * @property-read int|null $excels_count
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|User whereOauthTokenExpiredAt($value)
...
class User extends Authenticatable
{
    ...
    protected $casts = [
        ...
        'password' => 'hashed',
        'oauth_token_expired_at' => 'datetime',
    ];
